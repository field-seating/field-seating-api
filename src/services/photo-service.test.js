...
describe('photo-service.getPhotos', () => {
  ...
  //     const photoFive = await photoModel.createPhoto(
  //       'photoFive',
  //       userId,
  //       spaceId,
  //       new Date('2022-06-30')
  ...
  //     const photosSecond = await photoService.getPhotos(
  //       startPhotoId,
  //       limit,
  //       photos.pagination.cursorId
  //     );
  //     console.log(photosSecond);

  //     const photosThird = await photoService.getPhotos(
  //       startPhotoId,
  //       limit,
  //       photosSecond.pagination.cursorId
  //     );
  ...
  //       ) &&
  //       isEmpty(
  //         photosSecond.data.filter((photo) => photo.id === allPhotos.data[2].id)
  //       ) &&
  //       isEmpty(
  //         isEmpty(photosThird)
  //           ? []
  ...
  //     expect(photos.data[2]).toHaveProperty('data');
  //     expect(photos).toHaveProperty('pagination');
  //     expect(photos.pagination).toMatchObject(expectedPaginationData);
  //   });
  // });
